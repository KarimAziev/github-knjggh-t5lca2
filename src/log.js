...
function w3CodeColorize(x, lang) {
  ...
  function tagMode(txt) {
    ...
    result = done + rest;
    result =
      "<span class='tagcolor' style=color:" +
      tagcolor +
      '>&lt;</span>' +
      result.substring(4);
    ...
    return (
      "<span class='tagnamecolor' style=color:" +
      tagnamecolor +
      '>' +
      result +
      '</span>'
  ...
  function attributeMode(txt) {
    ...
    return (
      "<span class='attributecolor' style=color:" +
      attributecolor +
      '>' +
      done +
      rest +
  ...
  function attributeValueMode(txt) {
    return (
      "<span class='attributevaluecolor' style=color:" +
      attributevaluecolor +
      '>' +
      txt +
      '</span>'
  ...
  function angularMode(txt) {
    return (
      "<span class='angularstatementcolor' style=color:" +
  ...
  function commentMode(txt) {
    return (
      "<span class='commentcolor' style=color:" +
      commentcolor +
      '>' +
      txt +
      '</span>'
  ...
  function cssMode(txt) {
    ...
    rest = rest.replace(
      /{/g,
      "<span class='cssdelimitercolor' style=color:" +
        cssdelimitercolor +
        '>{</span>'
    );
    rest = rest.replace(
    ...
    return (
      "<span class='cssselectorcolor' style=color:" +
      cssselectorcolor +
      '>' +
      rest +
      '</span>'
  ...
  function cssPropertyMode(txt) {
    ...
    return (
      "<span class='csspropertycolor' style=color:" +
      csspropertycolor +
      '>' +
      done +
      rest +
  ...
  function cssPropertyValueMode(txt) {
    ...
    return (
      "<span class='csspropertyvaluecolor' style=color:" +
  ...
  function cssImportantMode(txt) {
    return (
      "<span class='cssimportantcolor' style=color:" +
      cssimportantcolor +
      ';font-weight:bold;>' +
      txt +
      '</span>'
  ...
  function jsMode(txt) {
    ...
    return (
      "<span class='jscolor' style=color:" + jscolor + '>' + rest + '</span>'
    );
  }
  function jsRegExpMode(txt) {
    return (
      "<span class='jsregexpcolor' style=color:" +
      jsregexpcolor +
      '>' +
      txt +
      '</span>'
  ...
  function jsStringMode(txt) {
    return (
      "<span class='jsstringcolor' style=color:" +
      jsstringcolor +
      '>' +
      txt +
      '</span>'
  ...
  function jsStringTempMode(txt) {
    return (
      "<span class='jsstringtempcolor' style=color:" +
      jsstringtempcolor +
      '>' +
      txt +
      '</span>'
  ...
  function jsKeywordMode(txt) {
    return (
      "<span class='jskeywordcolor' style=color:" +
      jskeywordcolor +
      '>' +
      txt +
      '</span>'
  ...
  function jsNumberMode(txt) {
    return (
      "<span class='jsnumbercolor' style=color:" +
      jsnumbercolor +
      '>' +
      txt +
      '</span>'
  ...
  function jsPropertyMode(txt) {
    return (
      "<span class='jspropertycolor' style=color:" +
      jspropertycolor +
      '>' +
      txt +
      '</span>'
  ...
  function getRegExpPos(txt, func) {
    ...
    if (pos1 > -1) {
      ...
      if (
        (txt.substr(pos1 + len, 1) != '/' &&
          txt.substr(pos1 + len, 1).match(patt) &&
  ...
  function javaMode(txt) {
    ...
    return (
      "<span class='javacolor' style=color:" +
      javacolor +
      '>' +
      rest +
      '</span>'
  ...
  function javaStringMode(txt) {
    return (
      "<span class='javastringcolor' style=color:" +
      javastringcolor +
      '>' +
      txt +
      '</span>'
  ...
  function javaKeywordMode(txt) {
    return (
      "<span class='javakeywordcolor' style=color:" +
      javakeywordcolor +
      '>' +
      txt +
      '</span>'
  ...
  function javaNumberMode(txt) {
    return (
      "<span class='javanumbercolor' style=color:" +
      javanumbercolor +
      '>' +
      txt +
      '</span>'
  ...
  function javaPropertyMode(txt) {
    return (
      "<span class='javapropertycolor' style=color:" +
      javapropertycolor +
      '>' +
      txt +
      '</span>'
  ...
  function kotlinMode(txt) {
    ...
    return (
      "<span class='kotlincolor' style=color:" +
      kotlincolor +
      '>' +
      rest +
      '</span>'
  ...
  function kotlinStringMode(txt) {
    return (
      "<span class='kotlinstringcolor' style=color:" +
      kotlinstringcolor +
      '>' +
      txt +
      '</span>'
  ...
  function kotlinKeywordMode(txt) {
    return (
      "<span class='kotlinkeywordcolor' style=color:" +
      kotlinkeywordcolor +
      '>' +
      txt +
      '</span>'
  ...
  function kotlinNumberMode(txt) {
    return (
      "<span class='kotlinnumbercolor' style=color:" +
      kotlinnumbercolor +
      '>' +
      txt +
      '</span>'
  ...
  function kotlinPropertyMode(txt) {
    return (
      "<span class='kotlinpropertycolor' style=color:" +
      kotlinpropertycolor +
      '>' +
      txt +
      '</span>'
  ...
  function sqlMode(txt) {
    ...
    rest = done + rest;
    return (
      "<span class='sqlcolor' style=color:" + sqlcolor + '>' + rest + '</span>'
    );
  }
  function sqlStringMode(txt) {
    return (
      "<span class='sqlstringcolor' style=color:" +
      sqlstringcolor +
      '>' +
      txt +
      '</span>'
  ...
  function sqlKeywordMode(txt) {
    return (
      "<span class='sqlkeywordcolor' style=color:" +
      sqlkeywordcolor +
      '>' +
      txt +
      '</span>'
  ...
  function phpMode(txt) {
    ...
    rest = done + rest;
    rest =
      "<span class='phptagcolor' style=color:" +
      phptagcolor +
      '>&lt;' +
      rest.substr(4, 4) +
      '</span>' +
    ...
    return (
      "<span class='phpcolor' style=color:" + phpcolor + '>' + rest + '</span>'
    );
  }
  function phpStringMode(txt) {
    return (
      "<span class='phpstringcolor' style=color:" +
      phpstringcolor +
      '>' +
      txt +
      '</span>'
  ...
  function phpNumberMode(txt) {
    return (
      "<span class='phpnumbercolor' style=color:" +
      phpnumbercolor +
      '>' +
      txt +
      '</span>'
  ...
  function phpKeywordMode(txt) {
    ...
    if (glb.indexOf(txt.toUpperCase()) > -1) {
      if (glb.indexOf(txt) > -1) {
        return (
          "<span class='phpglobalcolor' style=color:" +
          phpglobalcolor +
          '>' +
          txt +
          '</span>'
      ...
      return (
        "<span class='phpkeywordcolor' style=color:" +
        phpkeywordcolor +
        '>' +
        txt +
        '</span>'
  ...
  function pythonMode(txt) {
    ...
    rest = done + rest;
    return (
      "<span class='pythoncolor' style=color:" +
      pythoncolor +
      '>' +
      rest +
      '</span>'
  ...
  function pythonStringMode(txt) {
    return (
      "<span class='pythonstringcolor' style=color:" +
      pythonstringcolor +
      '>' +
      txt +
      '</span>'
  ...
  function pythonNumberMode(txt) {
    return (
      "<span class='pythonnumbercolor' style=color:" +
      pythonnumbercolor +
      '>' +
      txt +
      '</span>'
  ...
  function pythonKeywordMode(txt) {
    return (
      "<span class='pythonkeywordcolor' style=color:" +
      pythonkeywordcolor +
      '>' +
      txt +
      '</span>'
...
export function log(...args) {
  ...
  args.forEach((arg) => {
    const val = serialize(arg, true);
    const formattedCode = formatCode(val);
    const code = document.createElement('pre');
    // code.style = 'border:1px solid red;';

    code.onclick = (e) => {
      console.log('parserTypeScript:', e);
      navigator.clipboard.writeText(formattedCode);
      showMessage('Copied!', 500);
    };

    code.innerHTML = w3CodeColorize(formattedCode, 'js');
    el.appendChild(code);
  });
